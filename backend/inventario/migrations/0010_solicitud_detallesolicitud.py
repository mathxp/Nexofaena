...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('inventario', '0009_alter_insumo_stock_actual_alter_insumo_stock_minimo'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solicitud', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventario.solicitud')),
            ],
        ),
    ]
